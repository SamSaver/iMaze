          ...
          <div className="flex flex-row p-4 w-full h-full">
            {algo == "2" && (
              <div className="flex-1 flex items-center justify-center">
                <Dijkstra grid={grid} mazeSetter={mazeSetter} />
              </div>
            )}
            {algo == "1" && (
              <div className="flex-1 flex items-center justify-center">
                <Bfs grid={grid} mazeSetter={mazeSetter} />
              </div>
            )}
            {algo == "0" && (
              <div className="flex-1 flex items-center justify-center">
            ...
            {algo == "3" && (
              <div className="flex-1 flex items-center justify-center">
                <Astar grid={grid} mazeSetter={mazeSetter} />
              </div>
            )}
            {algo == "4" && (
              <div className="flex-1 flex items-center justify-center">
                <GreedyBfs grid={grid} mazeSetter={mazeSetter} />
              </div>
            )}
            {algo == "5" && (
              <div className="flex-1 flex items-center justify-center">
                <Dfs grid={grid} mazeSetter={mazeSetter} />
              </div>
            )}
            {algo == "6" && (
              <div className="flex-1 flex items-center justify-center">
                <Ids grid={grid} mazeSetter={mazeSetter} />
              </div>
            )}
            {/* <ConfigComponent /> */}
          </div>
